...
int main() {
    std::cout << "Starting Dictionary tests..." << std::endl;
    ...
    // Test exception behavior for currentKey() and currentVal() when current is undefined
    ...
    std::cout << "All Dictionary tests passed successfully!" << std::endl;
    return 0;
}